...
// Характеристики: имя, баланс, корзина (продукты).
// Ограничения: имя не пустое, не короче 3 символов; баланс >= 0.
...
public class Person {
    ...
    public String toString() {
        if (cart.isEmpty()) {
            return name + " - Ничего не куплено. Баланс: " + balance;
        } else {
            ...
            sb.append(". Баланс: ").append(balance);
            return sb.toString();
        }
    }
